...
parser.add_argument("--language_model",type=str,help="linear")
...
def load_peft_model():
    ...
    lora_model.base_model.add_weighted_adapter(adapters = ['zh','math'],weights = [0.1,1.1],adapter_name = "zh-math",combination_type='linear')
...
@app.route("/vllm-url41-infer", methods=["POST"])
def main():
