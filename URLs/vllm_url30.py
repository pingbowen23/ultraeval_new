...
parser.add_argument("--gpuid", type=str, default="5", help="GPUid to be deployed")
parser.add_argument("--port", type=int, default=5030, help="the port")
...
@app.route("/vllm-url30-infer", methods=["POST"])
def main():
